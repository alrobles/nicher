...
get_example_data <- function(file){
  exampleMatch <- c("Mshp", "stack_1_12", "stack_1_12_19", "stack_1_12_crop", "test", "Mshp_test", "occpts_pellaea_pternifolia", "msample_pellaea_pternifolia", "sciurus_aberti_pts", "sciurus_aberti_M")
  if( ! file %in% exampleMatch )  {
    stop("File not found. \n
          Only Mshp, stack_1_12, stack_1_12_19, occpts_pellaea_pternifolia, msample_pellaea_pternifolia, sciurus_aberti_pts, sciurus_aberti_M and test are valid. /n
         Check spell")
  }
