...
# Run multi-start optimization using Sobol design (weighted model)
...
# Presence-only model (no background data required)
...
| `"presence_only"` | Multivariate normal, presence points only |
