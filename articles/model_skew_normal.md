# Model 4: Skew-Normal Niche (Azzalini & Capitanio 1999)

## 1 Ecological Motivation

Many species exhibit asymmetric environmental tolerances: they may
tolerate higher temperatures much better than lower temperatures (or
vice versa), so the niche boundary is not symmetric around the optimum.
The multivariate normal model (Models 1–3) forces ellipsoidal symmetry,
...
- When ecological knowledge or exploratory analysis suggests
  **asymmetric environmental tolerances** (e.g. thermal tolerance
  asymmetry in ectotherms).
